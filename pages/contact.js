...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5 fill-current">
        <path d="M15.86 3c.18 1.53 1.05 3 2.64 3.93A5.9 5.9 0 0 0 22 7.7v2.77a8.8 8.8 0 0 1-3.86-.91v5.33c0 3.42-2.76 6.11-6.25 6.11a6.18 6.18 0 0 1-4.1-1.53A5.94 5.94 0 0 1 5.86 15c0-3.42 2.76-6.11 6.25-6.11.29 0 .57.02.84.07v2.93a3.2 3.2 0 0 0-.84-.11c-1.77 0-3.2 1.36-3.2 3.05 0 1.03.53 1.94 1.34 2.5.52.36 1.15.56 1.86.56 1.77 0 3.2-1.36 3.2-3.06V3h2.55Z" />
      </svg>
    ),
  },
];
          ...
          <div>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              <article className="rounded-[2rem] border border-forest/10 bg-white p-8 shadow-soft">
                <h2 className="text-xl font-semibold text-forest">Office Details</h2>
              ...
              <article className="rounded-[2rem] border border-forest/10 bg-white p-8 shadow-soft">
                <h2 className="text-xl font-semibold text-forest">Office Hours</h2>
                <div className="mt-4 space-y-3 text-sm leading-7 text-ink/75">
                  <p>Monday-Saturday: 8:00 AM - 6:00 PM (EAT)</p>
                  <p>Sunday: Closed (By appointment only)</p>
                </div>

                <h3 className="mt-6 text-sm font-semibold uppercase tracking-[0.2em] text-gold">Social Media</h3>
            ...
            <article className="mt-8 overflow-hidden rounded-[2rem] border border-forest/10 bg-white shadow-soft">
              <div className="border-b border-forest/10 px-8 py-6">
                <h2 className="text-xl font-semibold text-forest">Ruiru Location Map</h2>
                <p className="mt-2 text-sm leading-7 text-ink/75">
                  View our main office area in Ruiru, Kiambu County.
                </p>
              </div>
              <iframe
                title="Map of Ruiru, Kiambu County"
                src="https://maps.google.com/maps?q=Ruiru%2C%20Kiambu%20County%2C%20Kenya&z=13&output=embed"
