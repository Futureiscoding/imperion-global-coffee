        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:py-28">
          <div className="max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link href="/coffee/lots" className="inline-flex items-center justify-center rounded-full border border-white/35 px-6 py-3 text-sm font-semibold text-white hover:border-gold hover:text-gold">
                View Available Lots
              </Link>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <Link href="/quality-assurance" className="inline-flex rounded-full border border-forest/20 px-5 py-3 text-sm font-semibold text-forest hover:border-gold hover:text-gold">
                Quality Assurance
              </Link>
            </div>
          </div>
